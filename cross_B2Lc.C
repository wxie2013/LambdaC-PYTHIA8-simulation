...
void cross_B2Lc()
{
    ...
    //---------------------------------------------------------------------------------------
    string infile = "/depot/cms/users/wxie/B2Lc/CR2_soft_nonDiffractive_ON_1B_EvtGen/tot.root";
    string outfile = "root_file/cross_CR2_soft_nonDiffractive_ON_1B_EvtGen.root";
